    ...
    return (
        <>
            <div className="container mx-auto p-6">
                <h2 className="text-3xl font-[Nunito-ExtraBold] text-[#2A3B4D] mb-8">Order History</h2>
                                ...
                                {orders.map((order) => (
                                    ...
                                    >
                                        <td className="p-4 text-[#4A4A4A]">
                                            <span className="font-[Nunito-Bold]">#{order._id.slice(-6)}</span>
                                        </td>
                                        <td className="p-4 text-[#D87C5A] font-[Nunito-Bold]">
                                            Rs. {order.totalPrice}
                                        </td>
                                        <td className="p-4">
                                            <span className={`px-3 py-1 rounded-full text-sm font-[Nunito-Bold] ${order.status === "pending"
